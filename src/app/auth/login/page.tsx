      ...
      <div className="bg-white/30 backdrop-blur-xl min-h-screen w-full flex justify-center items-center shadow-lg p-6 md:p-8 lg:p-10">
        ...
        >
          <div className="w-full text-center">
            <Image src={logo} alt="Logo" className="mx-auto md:h-14 h-12 w-auto" />
            ...
            <h2 className="text-2xl font-semibold text-gray-700">Login to your account</h2>
            <div className='flex justify-center mt-3'>
              <h2 className='text-md font-bold text-slate-900'>Don&apos;t have an account?</h2>
              <Link href='/auth/signup' className='text-md font-bold text-custom-pink/95 ml-1'>Sign up now</Link>
            </div>
          </div>
          ...
          <div className="w-full">
            <label htmlFor="login" className="block text-sm font-medium text-gray-700">Username or Email</label>
            <input
              id="login"
              className={`mt-1 block w-full px-3 py-2 border ${errors.login ? 'border-red-500' : 'border-gray-300'} rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm focus:shadow-lg focus:shadow-fuchsia-400`}
              {...register('login', {
