...
import { getWorkspacesById } from '@/actions/getWorkspaces';
      ...
      <div className='h-[90%] w-full bg-custom-gradient p-8 overflow-y-auto'>
        {workspaces.length === 0 ? (
          <div className='flex items-center justify-center h-full'>
            <p className='text-white text-xl font-semibold text-center'>No workspaces available. Click &quot;New Workspace&quot; to create one.</p>
          </div>
        ) : (
